...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.ignore'
        db.add_column(u'account_userprofile', 'ignore',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.ignore'
        db.delete_column(u'account_userprofile', 'ignore')
