...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.current_gm'
        db.add_column(u'account_userprofile', 'current_gm',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.current_gm'
        db.delete_column(u'account_userprofile', 'current_gm')
