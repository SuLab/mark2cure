...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.turk_last_assignment_id'
        db.add_column(u'account_userprofile', 'turk_last_assignment_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.turk_last_assignment_id'
        db.delete_column(u'account_userprofile', 'turk_last_assignment_id')
