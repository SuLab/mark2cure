...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'account_userprofile', 'user_agent',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.player_ip'
        db.add_column(u'account_userprofile', 'player_ip',
                      self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39, null=True, blank=True),
                      keep_default=False)


        # Changing field 'UserProfile.motivation'
        db.alter_column(u'account_userprofile', 'motivation', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

    def backwards(self, orm):
        # Deleting field 'UserProfile.user_agent'
        db.delete_column(u'account_userprofile', 'user_agent')

        # Deleting field 'UserProfile.player_ip'
        db.delete_column(u'account_userprofile', 'player_ip')


        # Changing field 'UserProfile.motivation'
        db.alter_column(u'account_userprofile', 'motivation', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        u'account.userprofile': {
            ...
            'motivation': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
