...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.science_education'
        db.add_column(u'account_userprofile', 'science_education',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.country'
        db.add_column(u'account_userprofile', 'country',
                      self.gf('django_countries.fields.CountryField')(default='', max_length=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.science_education'
        db.delete_column(u'account_userprofile', 'science_education')

        # Deleting field 'UserProfile.country'
        db.delete_column(u'account_userprofile', 'country')
    ...
    models = {
        ...
        u'account.userprofile': {
            ...
            'current_gm': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'science_education': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
