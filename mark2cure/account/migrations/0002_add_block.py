...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.softblock'
        db.add_column(u'account_userprofile', 'softblock',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.softblock'
        db.delete_column(u'account_userprofile', 'softblock')
