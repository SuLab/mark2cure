...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'account_userprofile', 'gender')

        # Deleting field 'UserProfile.age'
        db.delete_column(u'account_userprofile', 'age')

        # Deleting field 'UserProfile.occupation'
        db.delete_column(u'account_userprofile', 'occupation')

        # Deleting field 'UserProfile.education'
        db.delete_column(u'account_userprofile', 'education')

        # Deleting field 'UserProfile.motivation'
        db.delete_column(u'account_userprofile', 'motivation')
    ...
    models = {
        ...
        u'account.userprofile': {
            ...
            'education': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            ...
            'motivation': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            ...
            'softblock': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
