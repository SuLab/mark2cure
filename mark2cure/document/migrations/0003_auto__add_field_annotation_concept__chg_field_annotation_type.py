...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'document_annotation', 'type', self.gf('django.db.models.fields.CharField')(max_length=40))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Annotation.type'
        db.alter_column(u'document_annotation', 'type', self.gf('django.db.models.fields.CharField')(max_length=12))
    ...
    models = {
        ...
        u'document.annotation': {
            ...
            'concept': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['common.Concept']", 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
