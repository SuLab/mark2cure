...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'document_activity', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('document', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['document.Document'])),
            ('task_type', self.gf('django.db.models.fields.CharField')(default='cr', max_length=3, blank=True)),
            ('experiment', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('submission_type', self.gf('django.db.models.fields.CharField')(default='gm', max_length=3, blank=True)),
            ('precsion', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=11, decimal_places=5, blank=True)),
            ('recall', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=11, decimal_places=5, blank=True)),
            ('f_score', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=11, decimal_places=5, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'document', ['Activity'])


    def backwards(self, orm):
        # Deleting model 'Activity'
        db.delete_table(u'document_activity')
    ...
    models = {
        ...
        u'document.activity': {
            ...
            'f_score': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '11', 'decimal_places': '5', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'precsion': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '11', 'decimal_places': '5', 'blank': 'True'}),
            'recall': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '11', 'decimal_places': '5', 'blank': 'True'}),
            'submission_type': ('django.db.models.fields.CharField', [], {'default': "'gm'", 'max_length': '3', 'blank': 'True'}),
        ...
        u'document.view': {
            'Meta': {'ordering': "('-updated',)", 'object_name': 'View'},
