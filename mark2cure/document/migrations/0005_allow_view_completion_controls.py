...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'View.task_type'
        db.add_column(u'document_view', 'task_type',
                      self.gf('django.db.models.fields.CharField')(default='cr', max_length=3, blank=True),
                      keep_default=False)

        # Adding field 'View.completed'
        db.add_column(u'document_view', 'completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'View.task_type'
        db.delete_column(u'document_view', 'task_type')

        # Deleting field 'View.completed'
        db.delete_column(u'document_view', 'completed')
