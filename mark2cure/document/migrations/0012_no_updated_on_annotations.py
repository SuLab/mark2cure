...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Annotation.updated'
        db.delete_column(u'document_annotation', 'updated')


    def backwards(self, orm):
        # Adding field 'Annotation.updated'
        db.add_column(u'document_annotation', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 6, 11, 0, 0), blank=True),
                      keep_default=False)
