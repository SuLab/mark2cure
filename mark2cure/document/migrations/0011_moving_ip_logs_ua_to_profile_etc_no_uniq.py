...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Annotation.experiment'
        db.delete_column(u'document_annotation', 'experiment')

        # Deleting field 'Annotation.player_ip'
        db.delete_column(u'document_annotation', 'player_ip')

        # Deleting field 'Annotation.user_agent'
        db.delete_column(u'document_annotation', 'user_agent')


    def backwards(self, orm):
        # Adding field 'Annotation.experiment'
        db.add_column(u'document_annotation', 'experiment',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Annotation.player_ip'
        db.add_column(u'document_annotation', 'player_ip',
                      self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Annotation.user_agent'
        db.add_column(u'document_annotation', 'user_agent',
    ...
    models = {
        ...
        u'document.annotation': {
            ...
            'type': ('django.db.models.fields.CharField', [], {'default': "'disease'", 'max_length': '40', 'null': 'True', 'blank': 'True'}),
