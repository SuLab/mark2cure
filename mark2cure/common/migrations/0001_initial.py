...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'common_concept', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('concept_id', self.gf('django.db.models.fields.TextField')()),
            ('annotation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['document.Annotation'])),
        ))
        db.send_create_signal(u'common', ['Concept'])

        # Adding model 'Message'
        db.create_table(u'common_message', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'common', ['Message'])

        # Adding model 'Quest'
        db.create_table(u'common_quest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'common', ['Quest'])

        # Adding M2M table for field documents on 'Quest'
        m2m_table_name = db.shorten_name(u'common_quest_documents')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('quest', models.ForeignKey(orm[u'common.quest'], null=False)),
            ('document', models.ForeignKey(orm[u'document.document'], null=False))
        ))
        db.create_unique(m2m_table_name, ['quest_id', 'document_id'])


    def backwards(self, orm):
        # Deleting model 'Concept'
        db.delete_table(u'common_concept')

        # Deleting model 'Message'
        db.delete_table(u'common_message')

        # Deleting model 'Quest'
        db.delete_table(u'common_quest')

        # Removing M2M table for field documents on 'Quest'
        db.delete_table(db.shorten_name(u'common_quest_documents'))
    ...
    models = {
        ...
        u'common.concept': {
            ...
            'annotation': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['document.Annotation']"}),
        ...
        u'common.quest': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'documents': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['document.Document']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
