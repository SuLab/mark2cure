...
class InstructionViews(TestCase, TestBase):
    ...
    def test_disease_marking(self):
        ...
        self.assertInHTML('<h2 class="text-xs-center">Disease Concept Marking Rules</h2>',
                          response.content)
    ...
    def test_gene_marking(self):
        ...
        self.assertEqual(response.status_code, 200)
        # self.assert_footers_in_html(response.content)
        self.assertInHTML('<h2 class="text-xs-center">Gene Concept Marking Rules</h2>',
                          response.content)
    ...
    def test_treatment_marking(self):
        ...
        self.assertEqual(response.status_code, 200)
        # self.assert_footers_in_html(response.content)
        self.assertInHTML('<h2 class="text-xs-center">Treatment Concept Marking Rules</h2>',
                          response.content)
